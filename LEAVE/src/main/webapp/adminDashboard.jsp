...
<head>
  ...
  <style>
   ...
   .pageWrap { padding: 32px 40px; max-width: 1300px; margin: 0 auto; }
    ...
    .stat-card.blue { border-color: var(--blue); background-color: #eff6ff; }
    .stat-card.orange { border-color: var(--orange); background-color: #fff7ed; }
    .stat-card.teal { border-color: var(--teal); background-color: #f0fdfa; }

    .card-label { font-size: 11px; font-weight: 800; color: var(--muted); text-transform: uppercase; letter-spacing: 0.05em; }
    .card-value { font-size: 32px; font-weight: 900; color: var(--text); line-height: 1; margin-top: 4px; }
    ...
    .chart-filter:focus { border-color: var(--blue-primary); color: var(--blue-primary); }

    .clock-box { text-align: right; }
    #clock { font-size: 24px; font-weight: 900; color: var(--text); font-variant-numeric: tabular-nums; }
    #date { font-size: 10px; font-weight: 700; color: var(--muted); text-transform: uppercase; }
  </style>
</head>
...
<body class="flex">
    ...
    <main class="main-content min-h-screen">
        ...
        <div class="pageWrap">
            ...
            <!-- Stats Grid - Full Line Outline Coloured -->
            ...
            <!-- Charts Section with Individual Year Filters -->
            <div class="grid grid-cols-12 gap-8">
                ...
                <div class="col-span-12 lg:col-span-7 chart-card">
                    <div class="chart-header">
                        ...
                        <select onchange="window.location.href='AdminDashboard?year='+this.value" class="chart-filter">
                            <% if(years != null) { for(String yr : years) { %>
                                <option value="<%=yr%>" <%= yr.equals(selectedYear)?"selected":"" %>><%=yr%></option>
                            <% } } %>
                        </select>
                    </div>
                    <div class="h-[350px]">
