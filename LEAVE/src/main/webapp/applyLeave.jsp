...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; font-family: 'Inter', Arial, sans-serif !important; }
    ...
    .modal { width: 440px; background: #fff; border-radius: 32px; padding: 48px; text-align: center; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25); }
...
<body class="flex">
  ...
  <div class="overlay" id="overlay">
    <div class="modal">
      ...
      <h3 class="text-2xl font-black uppercase tracking-tight text-slate-900">Success!</h3>
  ...
  <script>
    ...
    function handleTypeChange() {
      ...
      if (code.includes("SICK") || code === "SL") {
          ...
          addSelect("emergencyCategory", "Emergency Category", true, [
              ...
              {v: "DEATH", l: "DEATH (FAMILY)"},
              {v: "DISASTER", l: "NATURAL DISASTER"},
              {v: "MEDICAL_FAMILY", l: "FAMILY MEDICAL EMERGENCY"},
              {v: "OTHER", l: "OTHERS"}
          ]);
    ...
    if(params.get("msg") === "success") document.getElementById("overlay").classList.add("show");
  </script>
</body>
</html>