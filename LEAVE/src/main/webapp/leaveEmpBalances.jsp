...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; font-family: 'Inter', sans-serif !important; }
    ...
    .miniRow b { color: #0f172a; font-weight: 900; font-size: 11px; }
...
<body class="flex">
    ...
    <main class="flex-1 ml-20 lg:ml-64 transition-all duration-300">
        ...
        <div class="pageWrap">
            ...
            <% if (error != null) { %>
                <div class="bg-red-50 text-red-600 p-4 rounded-2xl mt-4 text-xs font-bold border border-red-100 uppercase flex items-center gap-3">
                    ...
                    <table>
                        ...
                        <tbody>
                            <% if (employees == null || employees.isEmpty()) { %>
                                <tr><td colspan="20" class="py-32 text-center text-slate-300 font-black uppercase text-xs tracking-widest italic">No staff records found</td></tr>
                            <% } else {
                            ...
                            %>
                                <tr class="<%= isInactive ? "row-inactive" : "" %>">
                                    <td>
                                        <div class="empBox">
                                            <div class="w-10 h-10 rounded-xl bg-slate-100 overflow-hidden flex-shrink-0 border border-slate-200 flex items-center justify-center shadow-sm">
                                            ...
                                            <div class="min-w-0 flex-1">
                                                ...
                                                <span class="emp-meta mt-1"><%= customId %></span>
                                                <span class="status-tag <%= isInactive ? "text-slate-400" : "text-emerald-600" %>">
                                                    <%= status %>
                                                </span>
                                            </div>
                                        </div>
